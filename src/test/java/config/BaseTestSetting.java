...
public class BaseTestSetting {
	...
	public static ExtentReports CreateExtentReport(String TestCaseName) throws IOException {
		...
		ExtentReports extent = new ExtentReports (ResultFolder+"//"+TestCaseName+"_"+fn_GetTimeStamp()+".html", true);
		extent
        .addSystemInfo("Host Name", "Testing")
	...
	public Object[][] GetData(String TestCaseName, String TestSheet) throws IOException {
		...
		try {
		   ...
		   System.out.println("The excel sheet data format is not correct, Testcase's Name should be under 'TestCaseName'");
		}
	...
	//This method will return True if Executable value is Y in data sheet, else return False
